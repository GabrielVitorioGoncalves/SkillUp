...
async function admBuscarCategorias(params) {
    const conex = await conectarBD();
...
module.exports = {
    conectarBD,buscarUsuario, buscarAdmin,verificarUsuarioExistente,cadastrarUsuario,buscarNotasPorCurso,calcularMediaDoCurso,
    admInserirCategoria, admBuscarCategorias,admBuscarCategoria,admBuscarCategoriaPorCodigo,admAtualizarCategoria, admExcluirCategoria
};
